...
$e_subject = 'Has sido contactada por ' . $name . '.';

$e_body = "has sido contactada por $name de tu formulario de contacto, su mensaje es el siguiente." . "\r\n" . "\r\n";

$e_content = "\"$comments\"" . "\r\n" . "\r\n";

$e_reply = "puedes contactar a $name via email, $email (o su telefono: $phone)";
